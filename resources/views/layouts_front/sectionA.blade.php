<section class="container-fluid about white-color no-padding" id="eventos">
    ...
    <div class="countdown section contact row no-margin">
        ...
        <div class="col-md-6 about-black-box">
						...
						<li class="wow fadeInUp" data-wow-delay=".2s">
							<span class="product-list-left pull-left">
									<a href="#" data-target="#product-01" data-toggle="modal">
										<img alt="product image" class="product-list-primary-img img-responsive" src="{{ asset('images/front/product3.png') }}"> 
										<img alt="product image" class="product-list-secondary-img img-responsive" src="{{ asset('images/front/product4.png') }}">
									</a>
							</span>
        	...
        	<h3 class="wow fadeInDown text-center "><b>Batalla after Office</b></h3>
        	<p class="textoBoxNegraDerecha">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
